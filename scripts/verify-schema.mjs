...
const expectedVersion="20260821_community_invite_atomic";
if(!url||!key){console.error("[schema-check] missing Supabase server environment variables");process.exit(1)}
const headers={apikey:key,Authorization:`Bearer ${key}`,Accept:"application/json"};
const required=["lobby_invites","voice_quality_samples","app_schema_state","communities","community_members","community_events","community_invites"];
