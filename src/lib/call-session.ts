...
export const callSession={
 ...
 leave(){state.micStream?.getTracks().forEach(t=>t.stop());state={lobbyId:null,micStream:null,muted:false,startedAt:null,metrics:{rttMs:null,bitrateKbps:null,packetsLost:null,updatedAt:null}};emit()},
};
