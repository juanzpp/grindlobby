...
import {ConnectionPanel,EventTicker,LevelHero,MusicBot,ProfileAvatar,StoreSection,TopElos} from "@/components/dashboard/LovableWidgets";
    ...
    <div className="flex min-h-screen">
      ...
      <main className="lovable-dashboard-main flex-1 space-y-4 p-4 md:p-6">
        ...
        {view==="dashboard"?<>
          ...
          <TopElos display={display} username={user.username} level={account.level} online={data?.online??[]}/>
        ...
        {view==="store"?<div className="lovable-dashboard-view"><StoreSection display={display} level={account.level}/></div>:null}
