...
export default function LobbyRoom({id,user}:{id:string;user:any}){
 ...
 const {remotePeers,setPeerVolume,togglePeerMuted,notifyVoiceLeave}=useLobbyVoice(id,user.id,memberIds,localStream);
