/**
 * Ambiente volumétrico procedural (sem imagem colada):
 * névoa em camadas, piso em perspectiva, feixes de luz, poeira e grão.
 * Usado no login e na tela de carregamento para dar sensação de lugar real.
 */
export function EnvironmentBackdrop({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      {/* Halo do portal, difuso e integrado */}
      <div
      ...
      {[-14, -6, 0, 7, 15].map((deg, i) => (
        <span
          ...
          style={{
            left: `${focusX + deg}%`,
            background:
              "linear-gradient(180deg, oklch(0.55 0.16 303 / 0.2), transparent 78%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(60% 100% at 50% 100%, oklch(0.22 0.07 300 / 0.42), transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(70% 100% at 40% 100%, oklch(0.18 0.05 292 / 0.7), transparent 72%)",
        }}
      />

      {/* Piso em perspectiva com fluxo de energia */}
      <div
        ...
        style={{
          ...
          maskImage:
            "linear-gradient(180deg, transparent, black 45%, transparent 95%)",
        }}
      />
      {/* Reflexo do portal no chão */}
      <div
        ...
        style={{
          ...
          transform: "translateX(-50%)",
          background:
            "radial-gradient(50% 100% at 50% 100%, oklch(0.5 0.17 303 / 0.24), transparent 72%)",
        }}
      />
      ...
      {/* Grão de filme + vinheta para fundir tudo */}
      <div
