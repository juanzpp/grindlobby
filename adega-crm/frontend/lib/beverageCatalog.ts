...
export const beverageCatalog:BeverageCatalogItem[]=[
  ...
  item('José Cuervo Especial','Tequila',750,'CUERVO750'), item('Bacardi Carta Blanca','Rum',980,'BAC980'), item('Cachaça 51','Cachaças',965,'C51965'), item('Jägermeister','Licores',700,'JAGER700'), item('Baileys Original','Licores',750,'BAIL750'), item('Beefeater London Dry','Gin',750,'BEEF750'), item('Stella Artois Long Neck','Cervejas',330,'STELLA330'), item('Brahma Duplo Malte','Cervejas',350,'BRAH350'), item('Amstel Lager','Cervejas',350,'AMST350'), item('Spaten Munich Helles','Cervejas',350,'SPAT350'), item('Original Pilsen','Cervejas',600,'ORIG600'), item('Monster Energy','Energéticos',473,'MON473'), item('Guaraná Antarctica','Refrigerantes',2000,'GUA2L'), item('Água Mineral sem gás','Águas',500,'AGUA500'), item('Suco de Laranja','Sucos',1000,'SUCLAR1L'), item('Chá Gelado Pêssego','Não alcoólicos',1500,'CHAP1L5'),
];
